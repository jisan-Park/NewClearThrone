...
HRESULT enemyBullet16_2::init()
{

	return S_OK;
}

void enemyBullet16_2::release()
{
}

void enemyBullet16_2::update()
{
	move();
...
void enemyBullet16_2::render(HDC hdc)
{
...
void enemyBullet16_2::setFrameIndex()
{
}

void enemyBullet16_2::move()
{
