...
HRESULT enemyBullet16_1::init()
{
	return S_OK;
}

void enemyBullet16_1::release()
{
}

void enemyBullet16_1::update()
{
	move();
...
void enemyBullet16_1::render(HDC hdc)
{
...
void enemyBullet16_1::setFrameIndex()
{
}

void enemyBullet16_1::move()
{
